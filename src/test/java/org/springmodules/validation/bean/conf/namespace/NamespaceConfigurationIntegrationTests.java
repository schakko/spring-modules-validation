...
/**
 * Tests for
 * {@link org.springmodules.validation.bean.conf.loader.xml.DefaultXmlBeanValidationConfigurationLoader}
 * .
 * 
 * @author Uri Boness
 */
public class NamespaceConfigurationIntegrationTests extends TestCase
{
	...
	protected void failedSetUp() throws Exception
	{
		ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext(
				"validation.xml", getClass());
	...
	public void failedLoadConfiguration() throws Exception
	{
	...
	public void failedLoadConfiguration_WithCustomHandlerFailure()
			throws Exception
	{
