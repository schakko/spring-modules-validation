 ...
 * </pre>
 * 
 * See the {@link org.springframework.core.style.DefaultValueStyler} class for a
 * concrete usage of this visitor helper.
 * 
 * <p>
 * <strong>Note</strong>: Copied from Spring 2.5 to avoid redoing work using
 * this.
 * 
 * @author Keith Donald
		...
		private Method findVisitMethod(Class rootArgumentType)
		{
			...
			while (!classQueue.isEmpty())
			{
				...
				try
				{
					...
					{
						logger.trace("Looking for method " + VISIT_METHOD + "("
								+ argumentType + ")");
					}
